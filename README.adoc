...
== Run the project on Command

To build the project, just use:

windows
----
java -jar target/vertx-start-project-1.0-SNAPSHOT-fat.jar -conf config/config.json
----

linux
----
java -jar vertx-start-project-1.0-SNAPSHOT-fat.jar -conf config/config.json
----
